...
[![Hyvä + Luma](https://img.shields.io/badge/Themes-Hyv%C3%A4%20%2B%20Luma-14b8a6)](https://hyva.io)
[![Claude Opus 4.7](https://img.shields.io/badge/Claude-Opus%204.7-D97757?logo=anthropic&logoColor=white)](https://platform.claude.com)
[![Tool Use](https://img.shields.io/badge/Tool%20Use-19%20tools-5B5BD6)](#tool-catalog--19-tools)
[![Prompt Cache](https://img.shields.io/badge/Prompt%20Cache-Enabled-22c55e)](https://docs.claude.com/en/docs/build-with-claude/prompt-caching)
[![Packagist](https://img.shields.io/badge/Packagist-mage2kishan%2Fmagento2--claude--ai-orange?logo=packagist&logoColor=white)](https://packagist.org/packages/mage2kishan/magento2-claude-ai)
[![GitHub](https://img.shields.io/badge/GitHub-mage2sk%2Fmagento2--claude--ai-181717?logo=github&logoColor=white)](https://github.com/mage2sk/magento2-claude-ai)
...
![Claude AI for Magento 2 — admin demo](docs/images/admin-dashboard-demo.gif)
...
![Admin sidebar — Claude AI Automation](docs/images/admin-menu.png)

### AI Dashboard — KPIs, quick actions, recent activity

![AI Dashboard with KPIs and quick prompts](docs/images/admin-dashboard.png)

### Ask Claude — the chat surface

| Empty state | Live conversation | Category tree response | Product creation with checkpoint |
|:---:|:---:|:---:|:---:|
| ![Ask Claude empty state](docs/images/admin-ask-claude-empty.png) | ![Chat — low stock query](docs/images/admin-chat-low-stock.png) | ![Chat — category tree](docs/images/admin-chat-category-tree.png) | ![Chat — create product with checkpoint](docs/images/admin-chat-create-product.png) |

### How to Use — 6-step plain-English onboarding

![How to Use Claude AI](docs/images/admin-how-to-use.png)

### Training Examples — teach Claude your store's conventions

| Examples grid | Edit form |
|:---:|:---:|
| ![Training Examples grid](docs/images/admin-training-examples.png) | ![Edit Training Example](docs/images/admin-training-edit.png) |

### Conversations — full transcript history

| Conversations grid | Single conversation transcript |
|:---:|:---:|
| ![Conversations grid](docs/images/admin-conversations.png) | ![Conversation detail with tool calls](docs/images/admin-conversation-detail.png) |

### Activity Log — every prompt, tool call, and reply

![Activity Log with token accounting](docs/images/admin-activity-log.png)

### Checkpoints & Restore — one-click undo

![Checkpoints & Restore grid](docs/images/admin-checkpoints-restore.png)

### Dashboard widget — Store Assistant on the admin landing page

![Store Assistant widget on admin Dashboard](docs/images/admin-dashboard-store-assistant-widget.png)

### Configuration — 6 groups, 25+ options

| API Credentials + General | Safety |
|:---:|:---:|
| ![API Credentials + General Settings](docs/images/admin-config-api-general.png) | ![Safety settings](docs/images/admin-config-safety.png) |

| Tool Capabilities (per-tool toggles) | Logging & Retention + Credits |
|:---:|:---:|
| ![Tool Capabilities](docs/images/admin-config-tool-capabilities.png) | ![Logging & Retention](docs/images/admin-config-logging-retention.png) |
...
![Edit Training Example form](docs/images/admin-training-edit.png)
